...
class VelocityFollowablePath(FollowablePath):
    ...
    # TODO explain why I have to use this 'pointers.' It is to make the library API the same across versions!
    # @property
    # def max_time(self):
    ...
    #     return self.is_unending
    #
    # @has_max_time.setter
    # def previous_time(self, value):
    #     self.is_unending = value
