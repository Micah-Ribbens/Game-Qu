...
class Button(TextBox):
    ...
    def set_colors(self, default_color, hover_color, clicked_color):
        """Sets the colors of the Button
            :parameter default_color: {red, green, blue}; The color of the button when the button isn't clicked or hovered over
            :parameter hover_color: {red, green, blue}; The color of the button when it is hovered over
            :parameter clicked_color: {red, green, blue}; The color of the button after it is clicked"""
