...
class Matrix:
    ...
    def get_vector_with_backing_list(self, backing_list):
        """:returns: Matrix; a matrix with the provided backing list"""

        return self.get_copy().set_backing_list(backing_list)

    def get_backing_list(self):
        """:returns: n x m list; the backing list"""
    ...
    def get_added_matrix(self, other_matrix):
        """:returns: Matrix; the matrix that results from adding the other matrix to this matrix (does not modify this matrix)"""
    ...
    def get_subtracted_matrix(self, other_matrix):
        """:returns: Matrix; the matrix that results from subtracting the other matrix from this matrix (does not modify this matrix)"""
    ...
    def get_constant_subtracted_matrix(self, constant):
        """:returns: Matrix; the matrix that results from subtracting a constant from all values in this matrix (does not modify this matrix)"""
    ...
    def get_constant_added_matrix(self, constant):
        """:returns: Matrix; the matrix that results from adding a constant to all values in this matrix (does not modify this matrix)"""
    ...
    def get_scalar_multiplied_matrix(self, scalar):
        """:returns: Matrix; the matrix that results from multiplying all values in this matrix by a scalar (does not modify this matrix)"""
    ...
    def get_hadamard_product_matrix(self, other_matrix):
        """:returns: Matrix; the matrix that results from the Hadamard product of this matrix with another matrix (does not modify this matrix)"""
    ...
    def get_copy(self):
        """:returns: Matrix; the copy of the current matrix"""
