...
class PiecewiseFunction(Function):
    ...
    def get_functions(self):
        """:returns: BoundedFunction; all the functions of the piecewise function"""

        return self.functions

    def set_functions(self, functions):
        """Sets the functions of the piecewise function
            returns: PiecewiseFunction; 'self'"""
    ...
    def get_piecewise_function_with_functions(self, functions):
        """:returns: PiecewiseFunction; a piecewise function with functions attribute being set to 'functions' (does not modify the current piecewise function)"""

        return self.get_copy().set_functions(functions)

    def get_copy(self):
        """:returns: PiecewiseFunction; a copy of the current piecewise_function"""
    ...
    def get_bounded_function_with_x_coordinates_less_than_min(self, x_coordinates_can_be_less_than_min):
        """:returns: PiecewiseFunction; a piecewise function with the is repeating attribute set to 'x_coordinates_can_be_less_than_min' (does not modify the current piecewise function)"""

        return self.get_copy().set_x_coordinates_can_be_less_than_min(x_coordinates_can_be_less_than_min)

    def get_is_repeating(self):
        """:returns: boolean; whether the piecewise function repeats"""
    ...
    def get_piecewise_function_with_is_repeating(self, is_repeating):
        """:returns: PiecewiseFunction; a piecewise function with the is repeating attribute set to 'is_repeating' (does not modify the current piecewise function)"""
    ...
    def get_piecewise_function_with_cleared_functions(self):
        """Returns a new PiecewiseFunction with cleared functions (does not modify the current piecewise function)
            returns: PiecewiseFunction; new piecewise function with cleared functions"""
    ...
    def get_piecewise_function_with_added_function(self, new_function):
        """ Returns a new PiecewiseFunction with the added function (does not modify the current piecewise function)
            :parameter new_function: Function; function to be added
    ...
    def get_y_coordinate(self, x_coordinate):
        """:returns: float; the y coordinate associated with that x coordinate"""

        return self.get_function(x_coordinate).get_y_coordinate(x_coordinate)

    def get_function(self, x_coordinate):
        """:returns: BoundedFunction; the function that controls the piecewise function at the x coordinate"""
    ...
    def get_before_piecewise_function(self):
        """:returns: PiecewiseFunction; a piecewise function that 'comes before' the original"""
    ...
    def get_x_relative_position(self, start, x_coordinate):
        """:returns: float; the distance x is from start (the relative position within the interval [start, end])"""

        return start - x_coordinate


    def get_min_x_coordinate(self):
        """:returns: float; the min x coordinate of the piecewise function (min x coordinate of min bounded function)"""

        return self.min_x_coordinate

    def get_max_x_coordinate(self):
        """:returns: float; the max x coordinate of the piecewise function (max x coordinate of max bounded function)"""

        return self.max_x_coordinate

    def get_bounds(self):
        """:returns: {min_x_coordinate, max_x_coordinate}; the bounds of the peicewise function"""
    ...
    def get_indefinite_integral(self):
        ...
        # TODO think about whether the domain would change by taking indefinite integral
    ...
    def get_derivative(self):
        ...
        # TODO think about whether the domain would change by taking the derivative
