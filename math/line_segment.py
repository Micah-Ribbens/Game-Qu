...
class LineSegment(Polynomial):
    ...
    def get_copy(self):
        """:returns: LineSegment; a copy of this LineSegment"""

        return LineSegment(self.start_point.get_copy(), self.end_point.get_copy())

    def get_inverted_function(self):
        """:returns: LineSegment; the line segment that is the inverse of this function (the y coordinates map to the x coordinate)"""
    ...
    def get_bounds(self):
        """:returns: {min_x_coordinate, max_x_coordinate} of this function"""
