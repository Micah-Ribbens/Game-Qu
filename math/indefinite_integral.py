...
class IndefiniteIntegral:
    ...
    def get_polynomial_indefinite_integral(polynomial):
        """:returns: Function; the indefinite integral of the polynomial (does not modify the passed in polynomial)"""
    ...
    def evaluate_polynomial_area(polynomial, start, end) -> float:
        """:returns: float; the area of the polynomial within the bounds of start and end"""

        return IndefiniteIntegral.get_polynomial_indefinite_integral(polynomial).evaluate(start, end)
