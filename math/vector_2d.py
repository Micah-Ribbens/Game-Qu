...
class Vector2D:
    ...
    def get_vector_with_x_and_y_magnitude(self, x_magnitude, y_magnitude):
        """ :returns: Vector2D; the vector with that specific x and y magnitude (this does not modify the current vector) """
    ...
    def get_vector_with_magnitude_and_angle(self, angle, magnitude):
        """ :returns: Vector2D; the vector with that specific magnitude and angle (this does not modify the current vector) """
    ...
    def get_vector_with_angle(self, angle):
        """ :returns: Vector2D; the vector with that specific angle (this does not modify the current vector) """
    ...
    def get_vector_with_magnitude(self, magnitude):
        """ :returns: Vector2D; the vector with that specific magnitude (this does not modify the current vector) """
    ...
    def get_vector_with_x_magnitude(self, x_magnitude):
        """ :returns: Vector2D; the vector with that specific x magnitude (this does not modify the current vector) """
    ...
    def get_vector_with_y_magnitude(self, y_magnitude):
        """ :returns: Vector2D; the vector with that specific y magnitude (this does not modify the current vector) """
    ...
    def get_normalized(self):
        """:returns: Vector2D; the normalized version of this vector"""

        return self.get_copy().normalize()

    def get_copy(self):
        """:returns: Vector2D; the copy of the current vector"""
    ...
    def get_added_vector(self, other_vector):
        """:returns: Vector2D; a new vector that is the result of adding another vector to this vector (does not modify the current vector)"""
    ...
    def get_subtracted_vector(self, other_vector):
        """:returns: Vector2D; the vector that results from subtracting the other vector from this vector (does not modify the current vector)"""
    ...
    def get_vector_multiplied_by_scalar(self, scalar):
        """:returns: Vector2D; a new vector that is the result of multiplying this vector by a scalar (does not modify the current vector)"""
    ...
    def get_hadamard_product(self, other_vector):
        """:returns: Vector2D; a new vector that is the result of performing a hadamard product on this vector (does not modify the current vector)"""
    ...
    def get_rotated_vector(self, angle):
        """:returns: Vector2D; the vector that results from rotating the current vector counter-clockwise by 'angle' (does not modify the current vector)"""
    ...
    def get_inverted_direction_vector(self):
        """:returns: Vector2D; the vector that results from rotating the current vector clockwise by pi degrees (does not modify the current vector)"""

        return self.get_copy().invert_vector_direction()

    def dot_product(self, other_vector):
        """:returns: float; the dot product of these two vectors"""
    ...
    def equals(self, other_vector):
        """:returns: boolean; whether the other vector equals this vector"""

        return other_vector.get_angle() == self.angle and other_vector.get_magnitude() == self.magnitude

    def __add__(self, other_vector):
        """:returns: The resulting vector from adding 'self' to 'other_vector'"""

        return self.get_added_vector(other_vector)

    def __sub__(self, other_vector):
        """:returns: The resulting vector from subtracting 'other_vector' from 'self'"""
