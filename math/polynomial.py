...
class PolynomialTerm:
    ...
    def get_degree(self) -> float:
        """:returns: float; the degree of the polynomail"""

        return self.degree

    def get_coefficient(self) -> float:
        """:returns: float; the coefficient"""

        return self.coefficient

    def set_degree(self, degree):
        """Sets the degree of the polynomial term to 'degree'
            returns: PolynomialTerm; 'self'"""

        self.degree = degree
        return self

    def get_polynomial_term_with_degree(self, degree):
        """:returns: PolynomialTerm; the polynomial term with that degree (does not modify the current polynomial term)"""
    ...
    def get_polynomial_term_with_coefficient(self, coefficient):
        """:returns: PolynomialTerm; the polynomial term with that coefficient (does not modify the current polynomial term)"""
    ...
    def get_polynomial_term_with_values(self, coefficient, degree):
        """:returns: PolynomialTerm; the polynomial term with those values (does not modify the current polynomial term)"""

        self.get_copy().set_values(coefficient, degree)

    def get_copy(self):
        """:returns: PolynomialTerm; a polynomial term copy"""

        return PolynomialTerm(self.coefficient, self.degree)

    def evaluate(self, x_value) -> float:
        """:returns: float; the value associated with that polynomial term"""
...
class Polynomial(Function):
    ...
    def set_matrix(self, matrix):
        """ Sets the matrix of terms. For instance, [1, 2, 3, 4] -> x^3 + 2x^2 + 3x + 4
            :returns: Polynomial; 'self'"""

        self.matrix = matrix
        return self

    def get_polynomial_with_matrix(self, matrix):
        """:returns: Polynomial; a polynomial with the given matrix (does not modify this polynomial)"""
    ...
    def get_terms(self):
        """:returns: PolynomialTerm[]; the terms of the polynomial"""

        return self.matrix.get_backing_list()

    def get_polynomial_with_terms(self, terms):
        """:returns: Polynommial; the polynomial with the given terms (does not modify this polynomial)"""

        return self.get_copy().set_terms(terms)

    def get_copy(self):
        """:returns: Polynomial; a copy of this polynomial"""
    ...
    def get_derivative(self):
        """:returns: Derivative; the derivative of the function"""
