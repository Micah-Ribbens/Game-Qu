...
def is_within_bounds(value, min_value, max_value):
    """ Checks if the 'value' is within the specified bounds
        :parameter value: float; value to be checked
        :parameter min_value: float; minimum bound
        :parameter max_value: float; maximum bound
        returns: bool; whether the value is within the specified bounds"""
